...
// create a for loop that will start at zero, go as long as index is less than the length of the array and increment each time by the size of the size(argument) and reassign i to new size
